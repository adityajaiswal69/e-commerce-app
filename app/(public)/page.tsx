...
const industries = [
  ...
  },
  {
    ...
    image: "/images/industries/shirt.png",
  ...
  return (
    ...
    <section className="container mx-auto px-4 py-5 md:py-8">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <p className="mb-8 md:mb-12 text-base md:text-lg leading-relaxed text-text-secondary">
  ...
  {industries.map((industry, index) => (
    ...
    >
      ...
      <section className="flex justify-center ">
        <Link
          href="/products"
          className="inline-flex items-center px-8 py-3 bg-primary-dark text-white font-medium rounded-md hover:bg-secondary-dark transition-colors duration-300"
        >
          View All Products
    ...
    {/* Custom Design Tool Section */}
      <section className="bg-gradient-to-br from-bg-light to-bg-light-end px-4 py-12 md:py-16">
        <div className="container mx-auto">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-base md:text-lg leading-relaxed text-text-secondary max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
              ...
              <div className="relative">
                  ...
                  <div className="bg-gray-100 rounded-lg p-4 mb-6">
                    ...
                    <div className="bg-white rounded-lg p-4 h-40 md:h-48 flex items-center justify-center border-2 border-dashed border-gray-300">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-primary-dark rounded-lg mx-auto mb-3 flex items-center justify-center">
                ...
                {/* Floating Elements */}
                <div className="absolute -top-4 -right-4 bg-primary-dark text-white px-3 py-1 rounded-full text-xs font-medium">
                  Professional
                </div>
                <div className="absolute -bottom-4 -left-4 bg-primary-dark text-white px-3 py-1 rounded-full text-xs font-medium">
                  Easy to Use
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-text-primary mb-2">Innovative Design Platform</h3>
                ...
                <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-text-primary mb-2">Expert Support & Analysis</h3>
                      <p className="text-sm text-text-tertiary leading-relaxed">
                ...
                <div className="bg-white rounded-xl p-6 md:p-8 shadow-lg">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-text-primary mb-2">Seamless Order Process</h3>
                      <p className="text-sm text-text-tertiary leading-relaxed">
            ...
            <div className="mt-12 md:mt-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <h4 className="font-semibold text-text-primary mb-2">2d Preview</h4>
                  <p className="text-xs text-text-tertiary">Visualize your design in  2d before ordering</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <h4 className="font-semibold text-text-primary mb-2">Brand Colors</h4>
                  <p className="text-xs text-text-tertiary">Match your exact brand colors with precision</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <p className="text-xs text-text-tertiary">Start with industry-specific design templates</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300">
                  ...
                  <h4 className="font-semibold text-text-primary mb-2">Expert Review</h4>
                  <p className="text-xs text-text-tertiary">Get professional feedback on your designs</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 md:mt-16 text-center">
              <div className="bg-primary-dark rounded-2xl p-8 md:p-12 text-white">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <button className="bg-bg-accent text-text-primary px-8 py-3 rounded-lg font-semibold hover:bg-gray-300 transition-colors duration-300 flex items-center">
      ...
      <section className="bg-bg-dark px-4 py-5 md:py-10 text-white">
        <div className="container mx-auto">
          <div className="mx-auto max-w-4xl text-center">
