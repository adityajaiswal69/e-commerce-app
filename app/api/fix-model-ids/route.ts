...
export async function GET(request: NextRequest) {
  try {
    ...
    // Stability AI models (with correct engine IDs)
      ...
      modelsToCreate.push(
        {
          ...
          is_enabled: true,
          is_default: false,
          model_settings: { width: 1024, height: 1024, steps: 30, cfg_scale: 7.5 }
        },
        {
          provider_id: stabilityProvider.id,
          model_id: 'stable-diffusion-xl-1024-v0-9',
          display_name: 'SDXL 1024 v0.9 (Stability AI)',
          description: 'Stable Diffusion XL v0.9 from Stability AI',
    ...
    return NextResponse.json({
      success: true,
      message: 'Models recreated with correct IDs',
