    ...
    <footer className="bg-[#333333] text-white">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Uniformat - The Uniform People. Quality uniforms for hospitality, healthcare, corporate, and educational institutions.
            </p>
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24" className="text-gray-300 hover:text-[#e9e2a3]">
          ...
          <div className="col-span-1">
            <h3 className="text-lg font-semibold mb-4 text-[#e9e2a3]">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className="col-span-1">
            <h3 className="text-lg font-semibold mb-4 text-[#e9e2a3]">Contact Us</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 mt-0.5 text-[#e9e2a3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span className="text-sm text-gray-300">123 Uniform Street, Fashion District, Mumbai, India</span>
              </li>
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#e9e2a3]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm text-gray-300">info@uniformat.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center md:text-left md:flex md:justify-between md:items-center">
          <p className="text-sm text-gray-400">© {currentYear} Uniformat. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <ul className="flex flex-wrap justify-center md:justify-end space-x-4 text-xs text-gray-400">
